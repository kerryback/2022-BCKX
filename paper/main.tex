%\documentclass[authoryear,letterpaper,english,12pt]{elsarticle_modified}
...
\usepackage{amsthm,amsmath,amsfonts,amssymb,xcolor,graphicx,babel,natbib,booktabs,chngcntr,comment,array,dcolumn, pdflscape, longtable, pgfplots, rotating,comment}
\usepackage{colortbl}
\usepackage{hhline}
\usepackage{multicol}
%\usepackage{subcaption}
\usepackage{ulem}    % TURN ON FOR STRIKE-OUT MARKUP
...
Introduction goes here.  Start with Uber/Lyft example.
